...
class ModelService:
    ...
    def __init__(
        self,
        model_path: str = "data/results/SIH_LandCover_ExtraTrees_MultiSource.pkl",
        fallback_model_path: str = "data/results/SIH_LandCover_RandomForest.pkl",
        predictions_path: str = "data/results/predictions_2018_2024.csv",
        raw_csv_path: str = "data/raw/SIH_SamePoints_2018_2024_Light.csv",
        benchmark_csv_path: str = "data/results/model_comparison_benchmark.csv",
        benchmark_json_path: str = "data/results/model_comparison_details.json",
        validation_json_path: str = "data/results/full_model_validation.json",
        leakage_json_path: str = "data/results/leakage_audit.json",
        ...
        self.predictions_path = _resolve_path(predictions_path, "SIH_OUTPUT/predictions_2018_2024.csv")
        self.raw_csv_path = _resolve_path(raw_csv_path, "SIH_SamePoints_2018_2024_Light.csv")
        self.benchmark_csv_path = _resolve_path(benchmark_csv_path, "SIH_OUTPUT/model_comparison_benchmark.csv")
        self.benchmark_json_path = _resolve_path(benchmark_json_path, "SIH_OUTPUT/model_comparison_details.json")
        self.validation_json_path = _resolve_path(validation_json_path, "SIH_OUTPUT/full_model_validation.json")
        self.leakage_json_path = _resolve_path(leakage_json_path, "SIH_OUTPUT/leakage_audit.json")
        self.loro_csv_path = _resolve_path(loro_csv_path, "SIH_OUTPUT/spatial_validation_LORO.csv")
        self.feedback_log_path = _resolve_path(feedback_log_path, "SIH_OUTPUT/human_review_log.json")
